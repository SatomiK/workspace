package jp.ac.utsunomiya.android.alarm.test;
...
public class MainActivity extends Activity implements SharedPreferences.OnSharedPreferenceChangeListener {         
		...
		private PendingIntent getPendingIntent() {    
			// 起動するアプリケーションを登録   
			Intent intent = new Intent( getApplicationContext(), AlarmTestActivity.class );
     ...
     // Dialog の 設定ボタンの設定   
        ...
        timePickerDialog.show();    // TimePickerDialog の作成   
        timePickerDialog = new TimePickerDialog(   
                this,     // 第1引数 : Context   
                listener, // 第2引数 : TimePickerDialog.OnTimeSetListener   
                mHour,    // 第3引数 : 時   
